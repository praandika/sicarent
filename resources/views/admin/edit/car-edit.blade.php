            ...
            <div class="card-body">
                ...
                <form action="{{ route('car.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="brand" id="brand" class="form-control" name="car_brand" placeholder="Ubah brand..."
                            value="{{ $o->car_brand }}" required>
                    </div>
                    <!-- Transmisi -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="car_type" value="{{ $o->car_type }}" required>
